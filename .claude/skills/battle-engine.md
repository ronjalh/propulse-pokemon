...
- [x] 33 unit tests passing in `engine.test.ts` — covers STAB, crits, immunities, dual-type stacking, burn physical penalty, paralysis speed, switch-first ordering, priority beats speed, end-of-turn burn/poison ticks, status inflict, PP decrement, input immutability, determinism, battle end
